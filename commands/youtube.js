...
module.exports = new Underline.Command({
  aliases: ["ytt", "youtubetogether", "w2g"],
  async onCommand(msg, { client, args, usedPrefix, usedAlias }) {
        ...
        Underline.client.discordTogether.createTogetherCode(msg.member.voice.channelID, 'youtube').then(async invite => {
